...
- `<h1>` : "Je cadre des _histoires_, je construis des _interfaces._" — 46–108px responsive (`clamp`), les mots en italique (`<em>`) sont couleur `--amber`.
...
- Gauche : kicker "06 — Contact", titre "On tourne _ensemble_ ?", un paragraphe.
